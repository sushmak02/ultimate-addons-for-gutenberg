			...
			if ( null === self::$block_attributes ) {
				self::$block_attributes = array(
					...
					'uagb/progress-bar'         => array(
						'slug'        => '',
						'title'       => __( 'Progress Bar', 'ultimate-addons-for-gutenberg' ),
						'description' => __( 'This block allows you to add and style your Progress Bar right in the Gutenberg editor.', 'ultimate-addons-for-gutenberg' ),
						'default'     => true,
						'js_assets'   => array( 'uagb-progress-bar-js' ),
						'attributes'  => array(
							'block_id'                      => '',
							'classMigrate'            		=> false,
							'progressValue'					=> '50',
							...
							'titleTextFontSubset'			=> '',
							'titleTextFontSize'				=> '',
							'titleTextFontSizeType'			=> 'px',
							'titleTextFontSizeTablet'		=> '',
							'titleTextFontSizeMobile'		=> '',
							'titleTextLineHeightType'		=>  'em',
							'titleTextLineHeight'			=> '',
		...
		public static function get_block_assets() {
			...
			if ( null === self::$block_assets ) {
				self::$block_assets = array(
					...
					'uagb-progress-bar-js' => array(
						'src'        => UAGB_URL . 'assets/js/progress-bar.js',
						'dep'        => array( 'jquery' ),
						'skipEditor' => true,
					)
				);
